...
public class GlobalExceptionHandler{
	...
	public ResponseEntity<MyErrorDetail> DpartmentExceptionHandlar(DepartmentException dpartmentExecption,
			WebRequest webRequest) {
		MyErrorDetail myError = new MyErrorDetail();
		myError.setTimeStamp(LocalDateTime.now());
		myError.setMessage(dpartmentExecption.getMessage());
	...
	public ResponseEntity<MyErrorDetail> DpartmentExceptionHandlar(EmployeeException employeeException,
			WebRequest webRequest) {
		MyErrorDetail myError = new MyErrorDetail();
		myError.setTimeStamp(LocalDateTime.now());
	...
	public ResponseEntity<MyErrorDetail> myMANVExceptionHandler(MethodArgumentNotValidException me) {
		MyErrorDetail err = new MyErrorDetail(LocalDateTime.now(),
				me.getBindingResult().getFieldError().getDefaultMessage(), "Validation Error");
